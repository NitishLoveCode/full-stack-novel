  ...
  return (
    <>
        <div className='grid grid-cols-3 sm:gap-10 mt-10 mb-10 justify-between'>
            ...
            <div className='flex  items-center mt-5 mb-20 justify-center'>
                <button className='bg-primary active:bg-purple-300 rounded-full text-white pl-4 pr-4 pt-1 pb-1'>Load more</button>
            </div>
